...
const SearchBar = () => {
  ...
  const updateSearchParams = (character: string) => {
    ...
    if (character) {
      searchParams.set("house", character);
    } else {
