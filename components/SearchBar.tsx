...
const SearchBar = () => {
  return (
    <form className="w-full block max-w-xs m-2">
          <div className="relative">
            ...
            <input type="search" id="default-search" className=" w-full p-3 pl-10 text-sm text-black border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Characters" required />
